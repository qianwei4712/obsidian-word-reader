...
const ENGLISH: PptxReaderText = {
  ...
  commands: {
    ...
    copyRenderDiagnostics: "Copy Office performance diagnostics",
  ...
  toolbar: {
    ...
    copyRenderDiagnostics: "Copy performance diagnostics",
  ...
  notices: {
    ...
    copiedRenderDiagnostics: "Copied Office performance diagnostics",
    noRenderDiagnostics: "No performance diagnostics are available",
...
const CHINESE: PptxReaderText = {
  ...
  commands: {
    ...
    copyRenderDiagnostics: "复制 Office 性能诊断",
  ...
  notices: {
    ...
    copiedRenderDiagnostics: "已复制 Office 性能诊断",
    noRenderDiagnostics: "当前没有可用的性能诊断",
