...
export interface PptxReaderText {
  ...
  notices: {
    ...
    copiedRenderDiagnostics: string;
    noRenderDiagnostics: string;
...
const ENGLISH: PptxReaderText = {
  ...
  commands: {
    ...
    copyRenderDiagnostics: "Copy presentation render diagnostics",
  ...
  toolbar: {
    ...
    copyRenderDiagnostics: "Copy render diagnostics",
  ...
  notices: {
    ...
    copiedRenderDiagnostics: "Copied presentation render diagnostics",
    noRenderDiagnostics: "No completed slide render diagnostics are available",
...
const CHINESE: PptxReaderText = {
  ...
  commands: {
    ...
    copyRenderDiagnostics: "复制演示文稿渲染诊断",
  ...
  notices: {
    ...
    copiedRenderDiagnostics: "已复制演示文稿渲染诊断",
    noRenderDiagnostics: "当前没有可用的完整幻灯片渲染诊断",
